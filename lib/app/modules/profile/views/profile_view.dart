...
import 'package:home_services_provider/app/models/global_model.dart';
import 'package:home_services_provider/app/services/global_service.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        Container(
          ...
          child:Obx(
            ()=> controller.isLoading.value?Row(
        ...
        body: Form(
          ...
          child: ListView(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Obx(
                        ...
                        child: Container(
                          ...
                          child: controller.user.value
                              .profileImg !=
                              null
                              ? Image.file( File(controller.user.value.profileImg))
                              : IconButton(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Image.network(Get.find<GlobalService>().baseUrl+controller.user.value.citizenshipFront,height: 80,),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Image.network(Get.find<GlobalService>().baseUrl+controller.user.value.citizenshipBack,height: 80,),
              ...
              TextFieldWidget(
                onSaved: (input) => controller.user.value.facebookUrl = input,

                initialValue: controller.user.value.facebookUrl,
                labelText: "Facebook Url".tr,
                iconData: Icons.link,
              ),
              TextFieldWidget(
                onSaved: (input) => controller.user.value.youtubeUrl = input,

                initialValue: controller.user.value.youtubeUrl,
                labelText: "Youtube Url".tr,
                iconData: Icons.link,
              ),
              TextFieldWidget(
                onSaved: (input) => controller.user.value.instagramUrl = input,

                initialValue: controller.user.value.instagramUrl,
