        ...
        bottomNavigationBar: Container(
          ...
          child: Row(
            children: [
              Obx(
              ()=> Expanded(
                  child:controller.isLoading.value?Center(child: CircularProgressIndicator()): MaterialButton(
                    onPressed: () {
              ...
              if (controller.isCreateForm())
                MaterialButton(
                  ...
                  child: Text("Save & Add Options".tr, style: Get.textTheme.bodyText2.merge(TextStyle(color: Get.theme.accentColor))),
                  elevation: 0,
                ),
            ],
